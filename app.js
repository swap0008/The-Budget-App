...
var UIController = (function () {
    ...
    return {
        ...
        displayBudget: function (obj) {
            var bugetLabel = document.querySelector(DOMstrings.budgetLabel);

            if (obj.budget > 0) {
                bugetLabel.textContent = "+" + formatNumber(obj.budget, 'inc');
            } else {
                bugetLabel.textContent = formatNumber(obj.budget, 'exp');
            }
        ...
        displayDate: function() {
            ...
            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'November', 'Deember'];
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function () {
        ...
        // 3. Update User Interface with the new precentages
